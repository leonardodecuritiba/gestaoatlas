...
it('should have a type="number" validator', () = > {
    expectValidation('foo', 'type', 'number'
).
not.to.be(true);
...
it('should have a type="digits" validator', () = > {
    expectValidation('foo', 'type', 'digits'
).
not.to.be(true);
...
it('should have a type="integer" validator', () = > {
    expectValidation('foo', 'type', 'integer'
).
not.to.be(true);
...
it('should have a type="alphanum" validator', () = > {
    expectValidation('foo', 'type', 'alphanum'
).
to.be(true);
...
it('should have a pattern validator', () = > {
    expectValidation('a', 'pattern', '[a-z]+'
).
to.be(true);
...
it('should have a pattern validator that behaves as the standard when not of the form /pattern/flag', () = > {
    expectValidation('aa', 'pattern', '[a-z]{1,2}'
).
to.be(true);
...
it('should have a pattern validator that extends the standard for form /pattern/flag', () = > {
    expectValidation('zAz', 'pattern', '/a/i'
).
to.be(true);
})
;
it('should have a length validator', () = > {
    expectValidation('foobar', 'length', [3, 9
]).
to.be(true);
...
it('should have a minlength validator', () = > {
    expectValidation('foo', 'minlength', 3
).
to.be(true);
...
it('should have a maxlength validator', () = > {
    expectValidation('foo', 'maxlength', 3
).
to.be(true);
...
it('should have a check validator', () = > {
    expectValidation(['foo', 'bar', 'baz'],               'check', [3, 5
]).
to.be(true);
...
it('should have a mincheck validator', () = > {
    expectValidation(['foo', 'bar', 'baz'], 'mincheck', 3
).
to.be(true);
...
it('should have a maxcheck validator', () = > {
    expectValidation(['foo', 'bar', 'baz'],        'maxcheck', 3
).
to.be(true);
...
it('should handle proper error message for validators', () = > {
    expect(validatorRegistry.getErrorMessage({name: 'length', requirements: [3, 6]})
).
