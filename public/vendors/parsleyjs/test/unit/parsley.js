...
append('<input type="submit" id="element" />');
var parsleyInstance = new Factory($('#element')[0]);
expect(parsleyInstance).to.be.an('object');
expect(parsleyInstance.__class__).to.be('Field');
})
...
append('<div id="element" data-parsley-validate></div>');
var parsleyInstance = new Factory($('#element')[0]);
expect(parsleyInstance).to.be.an('object');
expect(parsleyInstance.__class__).to.be('Form');
})
...
append('<form id="element" data-parsley-foo="bar" data-parsley-baz="baz"></form>');
...
append('<input type="text" id="element" data-parsley-namespace="baz-"></div>');
...
append('<form id="element" data-parsley-foo="bar"></form>');
