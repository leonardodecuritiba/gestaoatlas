    ...
    <div class="x_content">
        <div class="form-horizontal form-label-left">
            ...
            <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Atividade Econômica <span class="required">*</span></label>
                <div class="col-md-10 col-sm-10 col-xs-12">
                    <input value="{{($existe_entidade)?$Entidade->pessoa_juridica->ativ_economica:old('ativ_economica')}}"
                           type="text" class="form-control" name="ativ_economica" placeholder="Atividade Econômica" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Situação Cadastral Vigente <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input value="{{($existe_entidade)?$Entidade->pessoa_juridica->sit_cad_vigente:old('sit_cad_vigente')}}"
                           type="text" class="form-control" name="sit_cad_vigente" placeholder="Situação Cadastral Vigente" required>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input value="{{($existe_entidade)?$Entidade->pessoa_juridica->sit_cad_status:old('sit_cad_status')}}"
                           type="text" class="form-control" name="sit_cad_status" placeholder="Situação" required>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input value="{{($existe_entidade)?$Entidade->pessoa_juridica->data_sit_cad:old('data_sit_cad')}}"
                           type="text" class="form-control data-to-now" name="data_sit_cad" placeholder="Data Sit. Cadastral" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Regime de Apuração <span class="required">*</span></label>
                <div class="col-md-5 col-sm-5 col-xs-12">
                    <input value="{{($existe_entidade)?$Entidade->pessoa_juridica->reg_apuracao:old('reg_apuracao')}}"
                           type="text" class="form-control" name="reg_apuracao" placeholder="Regime de Apuração" required>
                </div>
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Data de Credenciamento como emissor de NF-e <span class="required">*</span></label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input value="{{($existe_entidade)?$Entidade->pessoa_juridica->data_credenciamento:old('data_credenciamento')}}"
                           type="text" class="form-control data-to-now" name="data_credenciamento" placeholder="Data Cred." required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Indicador de Obrigatoriedade de NF-e <span class="required">*</span></label>
                <div class="col-md-5 col-sm-5 col-xs-12">
                    <input value="{{($existe_entidade)?$Entidade->pessoa_juridica->ind_obrigatoriedade:old('ind_obrigatoriedade')}}"
                           type="text" class="form-control" name="ind_obrigatoriedade" placeholder="Indicador de Obrigatoriedade de NF-e" required>
                </div>
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Data de Início da Obrigatoriedade de NF-e <span class="required">*</span></label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input value="{{($existe_entidade)?$Entidade->pessoa_juridica->data_ini_obrigatoriedade:old('data_ini_obrigatoriedade')}}"
                           type="text" class="form-control data-to-now" name="data_ini_obrigatoriedade" placeholder="Data Ini." required>
                </div>
            </div>
        </div>
    </div>