                ...
                <div class="profile_details">
                    <div class="well profile_view">
                        <div class="col-xs-12">
                            ...
                            <div class="perfil left col-xs-8">
                                <h2></h2>
                                <p><strong></strong> <span></span></p>
                                <ul class="list-unstyled">
                                    <li><i class="fa fa-building"></i> Endereço: <span id="endereco"></span></li>
                                    <li><i class="fa fa-phone"></i> Telefones: <span id="fones"></span></li>
                                    <li><i class="fa fa-envelope"></i> Email: <span id="email"></span></li>
                                    <li><i class="fa fa-money"></i> Limite Crédito (técnica): <span id="tecnica"></span></li>
                                    <li><i class="fa fa-money"></i> Limite Crédito (comercial): <span id="comercial"></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
