<div class="form-group">
    <label class="control-label col-md-2 col-sm-2 col-xs-12">Numero: <span class="required">*</span></label>
    <div class="col-md-10 col-sm-10 col-xs-12">
        <input name="numero" type="text" maxlength="5" class="form-control" required
