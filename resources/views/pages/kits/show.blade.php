                            ...
                            <div class="x_content">
                                <div class="form-horizontal form-label-left">
                                    @foreach($Kit->pecas_kit as $ind => $peca_kit)
                                        <div id="kit_peca">
                                            <input name="idpecas_kit[{{$ind}}]" type="hidden" class="form-control" value="{{$peca_kit->idpeca_kit}}">
                                            <div class="form-group">
                                                <label class="control-label col-md-2 col-sm-2 col-xs-12">Peça/Produto: <span class="required">*</span></label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <select name="idpeca[{{$ind}}]" onchange="get_unidade(this)" class="form-control" required>
                                                ...
                                                <div class="col-md-2 col-sm-2 col-xs-12">
                                                    <a onclick="remove_peca(this)"
                                                       ...
                                                       class="btn btn-danger btn-sm btn-block"><i class="fa fa-times-circle"></i> Remover</a>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-2 col-sm-2 col-xs-12">Descrição Adicional: </label>
                                                <div class="col-md-10 col-sm-10 col-xs-12">
                                                    <input name="descricao_adicional[{{$ind}}]" type="text" class="form-control" placeholder="Descrição Adicional"
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input id="qtd" onchange="calc_total(this)" name="quantidade[{{$ind}}]" type="number" class="form-control" placeholder="Quantidade" required
                                                       value="{{$peca_kit->quantidade}}">
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input id="vlr" onchange="calc_total(this)" name="valor_unidade[{{$ind}}]" type="text" class="form-control show-valor" placeholder="Valor" required
